...
pub async fn relay_logic_calls(
    ...
    // Does this need a higher level log message? Information?
    ...
    let latest_ethereum_call = match get_logic_call_nonce(
    ...
    if latest_cosmos_call_nonce > latest_ethereum_call {
        let cost = match ethereum_gravity::logic_call::estimate_logic_call_cost(
