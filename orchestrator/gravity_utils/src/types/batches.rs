...
impl BatchTransaction {
    pub fn from_proto(input: cosmos_sdk_proto::gravity::SendToEthereum) -> Result<Self, GravityError> {
...
impl TransactionBatch {
    ...
    pub fn from_proto(input: cosmos_sdk_proto::gravity::BatchTx) -> Result<Self, GravityError> {
...
impl BatchConfirmResponse {
    pub fn from_proto(
        input: cosmos_sdk_proto::gravity::BatchTxConfirmation,
