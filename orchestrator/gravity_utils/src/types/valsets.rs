...
impl ValsetConfirmResponse {
    pub fn from_proto(
        input: cosmos_sdk_proto::gravity::SignerSetTxConfirmation,
...
impl From<cosmos_sdk_proto::gravity::SignerSetTxResponse> for Valset {
    fn from(input: cosmos_sdk_proto::gravity::SignerSetTxResponse) -> Self {
        Valset {
...
impl From<cosmos_sdk_proto::gravity::SignerSetTx> for Valset {
    fn from(input: cosmos_sdk_proto::gravity::SignerSetTx) -> Self {
        Valset {
            nonce: input.nonce,
...
impl From<cosmos_sdk_proto::gravity::EthereumSigner> for ValsetMember {
    fn from(input: cosmos_sdk_proto::gravity::EthereumSigner) -> Self {
...
impl From<&ValsetMember> for cosmos_sdk_proto::gravity::EthereumSigner {
    fn from(input: &ValsetMember) -> cosmos_sdk_proto::gravity::EthereumSigner {
        let ethereum_address = match input.eth_address {
            Some(e) => e.to_string(),
            None => String::new(),
        };
        cosmos_sdk_proto::gravity::EthereumSigner {
            power: input.power,
            ethereum_address,
        }
    }
